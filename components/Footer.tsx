        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <SubText className="text-gray-600 text-sm">
              Discover the best deals on ShopCentre
            </SubText>
            <SocialMedia 
          ...
          <div>
            ...
            <ul className="space-y-3 mt-4">
              {quickLinksData?.map((item)=>(
                <li key={item?.title}>
                  <Link href={item?.href} className="text-gray-600 hover:text-shop-light-green hoverEffect font-medium">
                  {item?.title}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 mt-4">
              {categoriesData?.map((item)=>(
                <li key={item?.title}>
                  <Link href={`/category/${item?.href}`} className="text-gray-600 hover:text-shop-light-green hoverEffect font-medium">
                  {item?.title}
                  </Link>
                </li>
              ))}
